...
const SolverDashboard = () => {
  ...
  const stats = [
    { label: "Proposal sent", value: 25, color: "text-blue-600" },
    { label: "Task accepted", value: 13, color: "text-red-500" },
    { label: "Total earned", value: "₦16,000", color: "text-[#00894E]" },
  ];
  ...
  const notifications = [
    {
      title: "New chat from Sarah A.",
      description: "Open the chat to view and respond to her task request.",
    },
    {
      title: "You have received #4,000 for...",
      description:
        "The client approved your submission for your ‘PHY101 task, check your wallet!",
    },
  ];
